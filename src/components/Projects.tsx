                        ...
                        >
                            {seasonData.projects.map((project) => (
                                <motion.div
                                    ...
                                    className={project.isGold ? "gold-card" : "glass-card"}
                                    style={{
                                        padding: '32px',
                                        display: 'flex',
                                ...
                                >
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                            <h3 style={{
                                                fontSize: '22px',
                                                fontWeight: 600,
                                                color: project.isGold ? '#FFD700' : '#fff',
                                            }}>
                                                {project.name}
                                            </h3>
                                            {project.isPinned && (
                                    ...
                                    <div style={{
                                        ...
                                        <a
                                            ...
                                            className={project.isGold ? "gold-btn" : "btn-primary"}
                                            style={{
                                                flex: 1,
                                        ...
                                        >
                                            ...
                                            {t({ vi: 'Xem trực tiếp', en: 'View Live' })}
                                        </a>
                                        {project.githubUrl && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className={project.isGold ? "gold-btn-secondary" : "btn-secondary"}
                                                style={{
                                                    flex: 1,
                                                    justifyContent: 'center',
                                                    minWidth: '120px',
